 ...
 */
class MutexAddConstraint : public DiscreteFactor {
 ...
 public:
  ...
  MutexAddConstraint(const DiscreteKey& dkey, const DiscreteKeys& dkeys,
  ...
  bool equals(const DiscreteFactor& other, double tol) const override {
    if (!dynamic_cast<const MutexAddConstraint*>(&other))
      return false;
    else {
      const MutexAddConstraint& f(static_cast<const MutexAddConstraint&>(other));
