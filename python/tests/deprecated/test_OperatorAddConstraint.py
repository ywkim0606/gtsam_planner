...
from gtsam_planner import OperatorAddConstraint, MultiValueConstraint
...
class TestMultiValueConstraint(GtsamTestCase):
    ...
    def setUp(self):
        ...
        self.op_add = gtsam_planner.OperatorAddConstraint(self.single_key, all_keys, [multi_0, multi_1, multi_2])
